 ...
 */
final class Version20190422175845 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE users ADD last_name TEXT DEFAULT NULL');
        $this->addSql('ALTER TABLE users ADD country TEXT DEFAULT NULL');
    }
